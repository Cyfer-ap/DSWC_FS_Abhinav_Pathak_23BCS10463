...
public class EcommerceSalesReport {
    public static void main(String[] args) {
        ...
        List<Transaction> transactions = Arrays.asList(
                new Transaction("TXN-001", "COMPLETED", "ELECTRONICS", 1200.00),
                new Transaction("TXN-002", "COMPLETED", "CLOTHING", 350.00),
                new Transaction("TXN-003", "PENDING", "ELECTRONICS", 800.00),
                new Transaction("TXN-004", "COMPLETED", "ELECTRONICS", 2500.00),
                new Transaction("TXN-005", "REFUNDED", "ELECTRONICS", 600.00),
                new Transaction("TXN-006", "COMPLETED", "BOOKS", 45.00),
                new Transaction("TXN-007", "COMPLETED", "ELECTRONICS", 3100.00),
                new Transaction("TXN-008", "COMPLETED", "ELECTRONICS", 750.00),
                new Transaction("TXN-009", "PENDING", "CLOTHING", 200.00),
                new Transaction("TXN-010", "COMPLETED", "ELECTRONICS", 1850.00)
        );
